...
function Cours() {
  ...
  return (
    <section className="pt-24">
      <img className="w-full h-full object-contain" src={Luna_Pauline} alt="Pauine entrain de donner des cours de piano"/>
      ...
      <div className="flex flex-col gap-6">
        <h1 className="text-5xl text-white  font-musique2">Professeur de Piano</h1>
      ...
      <h1 className="flex justify-center items-center text-9xl text-blue-950">Cours</h1>
    </section>
  )
}
